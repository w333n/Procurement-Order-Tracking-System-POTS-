...
public class ViewStockLevels extends javax.swing.JFrame {
    ...
    private String[]Columns = {"ItemCode","ItmName","ItemPrice","SupplierCode","CurrentNumbers","CurrentStockLevels"};
    public ViewStockLevels() {
        Table.setColumnIdentifiers(Columns);
        initComponents();
        gf.loadorsaveTableData("Load", "StockLevels.txt", jList1, Table);
    }
